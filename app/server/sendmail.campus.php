...
$email_subject = "Contato atraves do site [CAMPUS]" ;
$email_body = "Contato atraves do website [CAMPUS]";
$email_address = "marcello@oncase.com.br";

$name = $dataJS->name;
$email = $dataJS->email;
$page = $dataJS->page;
$course = $dataJS->course;
...
$email_body .= "<br /><br /><strong>page:</strong><br />".$page;
$email_body .= "<br /><br /><strong>course:</strong><br />".$course;
